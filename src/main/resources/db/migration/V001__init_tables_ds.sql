...
CREATE TABLE program_session_exercise_set (
    ...
    rpe SMALLINT,
    unit CHAR(1),
    CONSTRAINT program_session_exercise_set_fk01 FOREIGN KEY (program_session_id, exercise_id) REFERENCES program_session_exercise(program_session_id, exercise_id)
);
...
CREATE TABLE program_session_template_exercise_set (
    ...
    CONSTRAINT program_session_template_exercise_set_fk01 FOREIGN KEY (program_session_template_id, exercise_id) REFERENCES program_session_template_exercise(program_session_template_id, exercise_id)
);